...
import { schemaChangePassword, TypeChangePasswordSchema } from 'src/utils/rules';
...
export default function ChangePassword() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      if (isAxiosErrorUnprocessableEntity<ErrorResponseType<FormData>>(error)) {
  ...
  return (
    <div className='rounded-sm bg-white px-2 pb-10 shadow md:px-7 md:pb-20'>
      ...
      <form className='mt-4 mr-auto max-w-2xl md:mt-8' onSubmit={onSubmit}>
