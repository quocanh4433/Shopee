    ...
    <Fragment>
          ...
          .map((_, index) => (
            <li className='py-1 pl-2' key={index}>
              ...
              >
                ...
                {index !== 0 && <span className='hidden md:inline-block'>Trở lên</span>}
              </div>
            </li>
          ))}
      </ul>
      ...
      <ul className='flex md:hidden'>
        {Array(5)
          .fill(0)
          .map((_, index) => (
            <li className='mr-3 flex items-center text-sm' key={index}>
              <button className='flex items-center' onClick={() => handleFilterStar(5 - index)}>
